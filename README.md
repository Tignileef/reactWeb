...
## 과제 1: GitHub Actions 기반 S3 CI/CD
...
과제 1에서 사용한 GitHub repository를 AWS Amplify Hosting에 연결하여 같은 React 웹 시스템을 바로 호스팅합니다.

### Amplify 설정 값

```txt
Repository: https://github.com/Tignileef/reactWeb
Branch: main
...
```txt
https://main.d2xoywhkvc4izz.amplifyapp.com/
```
